...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = EphemeralMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main EphemeralMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and theEphemeral.variable.DefaultCustomVariable
